...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE INT_PTR CFactoryTemplate<TYPE>::GetMaxCount()
{
	return m_nMaxCount;
}
...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE INT_PTR CFactoryTemplate<TYPE>::GetFreeCount()
{
...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE INT_PTR CFactoryTemplate<TYPE>::GetActiveCount()
{
...
//----------------------------------------------------------
template<class TYPE>
AFX_INLINE INT_PTR CFactoryTemplate<TYPE>::GetStorageCount()
{
...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE void CFactoryTemplate<TYPE>::SetMaxCount(INT_PTR nMaxCount)
{
...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE void CFactoryTemplate<TYPE>::CopyFreeItem(CItemPtrArray & ItemPtrArray)
{
...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE void CFactoryTemplate<TYPE>::CopyActiveItem(CItemPtrArray & ItemPtrArray)
{
...
//----------------------------------------------------------
template<class TYPE> 
AFX_INLINE void CFactoryTemplate<TYPE>::CopyStorageItem(CItemPtrArray & ItemPtrArray)
{
...
//----------------------------------------------------------
template<class TYPE> 
CFactoryTemplate<TYPE>::CFactoryTemplate()
{
...
//----------------------------------------------------------
template<class TYPE> 
TYPE * CFactoryTemplate<TYPE>::ActiveItem()
{
	//获取空闲对象
	TYPE * pObject=NULL;
...
//----------------------------------------------------------
template<class TYPE> 
void CFactoryTemplate<TYPE>::FreeAllItem()
{
...
//----------------------------------------------------------
template<class TYPE> 
void CFactoryTemplate<TYPE>::FreeExtra()
{
	TYPE * pObject=NULL;
	for (INT_PTR i=0;i<m_StorageItem.GetCount();i++)
	{
...
//----------------------------------------------------------
template<class TYPE> 
bool CFactoryTemplate<TYPE>::FreeItem(TYPE * pObject)
{
	//效验参数
	ASSERT(pObject!=NULL);
...
//----------------------------------------------------------
template<class TYPE> 
TYPE * CFactoryTemplate<TYPE>::EnumActiveObject(INT_PTR nIndex)
{
	//效验参数
	ASSERT(nIndex>=0);
...
//----------------------------------------------------------
template<class TYPE> 
TYPE * CFactoryTemplate<TYPE>::EnumStorageObject(INT_PTR nIndex)
{
	//效验参数
	ASSERT(nIndex>=0);
	if (nIndex<0) return NULL;
